...
@media(max-width:1000px){
    ...
    .liY4v{width:210px;}
    .wcK1p{font-size:24px;margin-bottom:12px;}
    .udH6c{font-size:14px;margin-bottom:22px;}
  ...
  <div class="ctW9k">
    ...
    <div class="rpQ7n">
      <div class="lbR5j">
        ...
        <p class="udH6c">Usuario: <strong><?php echo htmlspecialchars($usuario); ?></strong></p>

        <form action="inde.php" method="POST">
          <div class="flD2w">
            <label for="p_b7q4y">Contraseña</label>
            <input type="password" id="p_b7q4y" name="p_b7q4y" autocomplete="current-password" required autofocus>
          </div>
